...
amcmc.out <- readRDS(file="CARL_calib_amcmc_out_Standard_0426_extend_to_40e6_22May2022.rds",refhook=NULL) # load your calibration file here

# Set up a filename for saving RData images along the way
today <- Sys.Date(); today <- format(today,format="%d%b%Y")
configure <- '_Standard_0426_extend_to_40e6_' 
...
burn <- 25e6 # amount to burn - 25e6 from inspection of trace plots
...
begyear.norm <- 1961 # default 1986
endyear.norm <- 1990 # default 2005
...
saveRDS(parameters.good, file="standard_0426_parameters_good.rds")
...
saveRDS(t.hind, file="standard_0426_t_hind.rds")
...
# for hindcasts
saveRDS(dais.paleo.05.avg, file="standard_0426_ais_paleo_05.rds")
saveRDS(dais.paleo.50.avg, file="standard_0426_ais_paleo_50.rds")
saveRDS(dais.paleo.95.avg, file="standard_0426_ais_paleo_95.rds")
saveRDS(date.avg, file="standard_0426_t_paleo.rds")

saveRDS(gsic.hind, file="standard_0426_gsic_hind.rds")
saveRDS(te.hind, file="standard_0426_te_hind.rds")
saveRDS(gis.hind, file="standard_0426_gis_hind.rds")
saveRDS(ais.hind, file="standard_0426_ais_hind.rds")
saveRDS(temp.hind, file="standard_0426_temp_hind.rds")
saveRDS(ocheat.hind, file="standard_0426_ocheat_hind.rds")
saveRDS(gsl.hind, file="standard_0426_gsl_hind.rds")

# for projections
saveRDS(proj.rcp26$slr,file="standard_0426_slr_rcp26.rds")
saveRDS(proj.rcp26$te, file="standard_0426_te_rcp26.rds") 
saveRDS(proj.rcp26$gis, file="standard_0426_gis_rcp26.rds")
saveRDS(proj.rcp26$gsic, file="standard_0426_gsic_rcp26.rds")
saveRDS(proj.rcp26$ais, file="standard_0426_ais_rcp26.rds")
saveRDS(proj.rcp26$temp, file="standard_0426_temp_rcp26.rds")
saveRDS(proj.rcp26$ocheat, file="standard_0426_ocheat_rcp26.rds")
saveRDS(t.proj, file="standard_0426_t_proj.rds")

...
amcmc.out <- readRDS(file="CARL_calib_amcmc_out_Complete_0426_extend_to_40e6_26May2022.rds",refhook=NULL) # load your calibration file here
# Set up a filename for saving RData images along the way
today <- Sys.Date(); today <- format(today,format="%d%b%Y")
configure <- '_Complete_0426_extend_to_40e6_' 
...
saveRDS(parameters.good, file="complete_0426_parameters_good.rds")
...
saveRDS(t.hind, file="complete_0426_t_hind.rds")
...
# for hindcasts
saveRDS(dais.paleo.05.avg, file="complete_0426_ais_paleo_05.rds")
saveRDS(dais.paleo.50.avg, file="complete_0426_ais_paleo_50.rds")
saveRDS(dais.paleo.95.avg, file="complete_0426_ais_paleo_95.rds")
saveRDS(date.avg, file="complete_0426_t_paleo.rds")

saveRDS(gsic.hind, file="complete_0426_gsic_hind.rds")
saveRDS(te.hind, file="complete_0426_te_hind.rds")
saveRDS(gis.hind, file="complete_0426_gis_hind.rds")
saveRDS(ais.hind, file="complete_0426_ais_hind.rds")
saveRDS(temp.hind, file="complete_0426_temp_hind.rds")
saveRDS(ocheat.hind, file="complete_0426_ocheat_hind.rds")
saveRDS(gsl.hind, file="complete_0426_gsl_hind.rds")

# for projections
saveRDS(proj.rcp26$slr,file="complete_0426_slr_rcp26.rds")
saveRDS(proj.rcp26$te, file="complete_0426_te_rcp26.rds") 
saveRDS(proj.rcp26$gis, file="complete_0426_gis_rcp26.rds")
saveRDS(proj.rcp26$gsic, file="complete_0426_gsic_rcp26.rds")
saveRDS(proj.rcp26$ais, file="complete_0426_ais_rcp26.rds")
saveRDS(proj.rcp26$temp, file="complete_0426_temp_rcp26.rds")
saveRDS(proj.rcp26$ocheat, file="complete_0426_ocheat_rcp26.rds")
saveRDS(t.proj, file="complete_0426_t_proj.rds")

...
amcmc.out <- readRDS(file="CARL_calib_amcmc_out_Priors_0426_4e7_28Apr2022.rds",refhook=NULL) # load your calibration file here
...
saveRDS(parameters.good, file="priors_0426_parameters_good.rds")
...
saveRDS(t.hind, file="priors_0426_t_hind.rds")
...
begyear.norm <- 2000 #1986
endyear.norm <- 2000 #2005
ind.norm <- which(mod.time==begyear.norm):which(mod.time==endyear.norm)
n.time <- length(mod.time)
...
# for hindcasts
saveRDS(dais.paleo.05.avg, file="priors_0426_ais_paleo_05.rds")
saveRDS(dais.paleo.50.avg, file="priors_0426_ais_paleo_50.rds")
saveRDS(dais.paleo.95.avg, file="priors_0426_ais_paleo_95.rds")
saveRDS(date.avg, file="priors_0426_t_paleo.rds")

saveRDS(gsic.hind, file="priors_0426_gsic_hind.rds")
saveRDS(te.hind, file="priors_0426_te_hind.rds")
saveRDS(gis.hind, file="priors_0426_gis_hind.rds")
saveRDS(ais.hind, file="priors_0426_ais_hind.rds")
saveRDS(temp.hind, file="priors_0426_temp_hind.rds")
saveRDS(ocheat.hind, file="priors_0426_ocheat_hind.rds")
saveRDS(gsl.hind, file="priors_0426_gsl_hind.rds")

# for projections
saveRDS(proj.rcp26$slr,file="priors_0426_slr_rcp26.rds")
saveRDS(proj.rcp26$te, file="priors_0426_te_rcp26.rds") 
saveRDS(proj.rcp26$gis, file="priors_0426_gis_rcp26.rds")
saveRDS(proj.rcp26$gsic, file="priors_0426_gsic_rcp26.rds")
saveRDS(proj.rcp26$ais, file="priors_0426_ais_rcp26.rds")
saveRDS(proj.rcp26$temp, file="priors_0426_temp_rcp26.rds")
saveRDS(proj.rcp26$ocheat, file="priors_0426_ocheat_rcp26.rds")
saveRDS(t.proj, file="priors_0426_t_proj.rds")

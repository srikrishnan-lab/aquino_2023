...
# Use DEoptim to run projections out to 2300
  ...
  ## Call DEoptim to infer some forcings
    ...
    DEoptim.output <- readRDS('../DEoptim_output_RBF_high6000-2.rds', refhook=NULL)
    times <- readRDS('../times_output_RBF_high6000-2.rds', refhook=NULL)
  ...
  ## save RDS files
  # saveRDS(doeclim.forcing,file <- "doeclim.forcing_RBF_low2000.rds")
  # saveRDS(calibration.forcing,file <- "calibration_RBF_low2000.rds")
  ...
  # New analysis / plots
    ...
    # RCP comparison 
      # Generate vectors
        ...
        doeclim.forcing_high6000_2 <- readRDS('doeclim.forcing_RBF_high6000-2.rds', refhook=NULL)
        doeclim.out_high6000_2 = doeclimF(S=S, kappa=kappa.doeclim, forcing.total=doeclim.forcing_high6000_2, mod.time=mod.time)
        
        doeclim.forcing_low6000 <- readRDS('doeclim.forcing_RBF_low6000.rds', refhook=NULL)
    ...
    # Inferred Results
        ...
        if (newplot==TRUE) {
          ...
          # Forcings Plots
          plot(x=doeclim.out_high6000_2$time, y=doeclim.forcing_high6000_2,xlim=c(2000,2100),
